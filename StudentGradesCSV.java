 ...
 * Method will Provide the filepath
 * Create string to be used to reach each line of csv file
 * pass in file name(student_Grade_CSV.csv) to FileReader
 * read next line of file and continue while loop, if there isnt a next line exit loop
 * split our line at all commas and assign values to a string array
 * displaying strings with 12 spaces of room, left justified, display contents at index
